...
-- Project Phase III: Autograder ADVANCED INSTRUCTORS ONLY [v5] Wednesday, November 30, 2022 @ 3:00am
...
begin
    ...
    ('sprince6', '333-44-5555', '2022-11-29', 38, 61000);
...
call magic44_reset_database_state();
set @stepCounter = 30;
call add_pilot_role ('sprince6', '101010', 19);
call magic44_query_check_and_run(13); -- pilots

-- [4] add_worker_role() SUCCESS case(s)
call magic44_reset_database_state();
set @stepCounter = 40;
call add_worker_role ('sprince6');
call magic44_query_check_and_run(14); -- workers
...
(0,12,'sprince6#333-44-5555#2022-11-29#38#61000##########'),
...
(20,12,'sprince6#333-44-5555#2022-11-29#38#61000##########'),
...
(140,14,'mrobot2##############'),
(140,14,'tmccall5##############'),
(150,19,'hf#1#100#6#0#fprefontaine6###southside######'),
...
(290,12,'sprince6#333-44-5555#2022-11-29#38#61000##########'),
...
(310,31,'csoares8#888-88-8888#57000#2019-02-25#26#n/a#n/a#no#######'),
(310,31,'echarles19#777-77-7777#27000#2021-01-02#3#n/a#n/a#yes#######'),
...
(310,31,'sprince6#333-44-5555#61000#2022-11-29#38#n/a#n/a#no#######'),
(310,31,'tmccall5#333-33-3333#33000#2018-10-17#29#n/a#n/a#no#######'),
